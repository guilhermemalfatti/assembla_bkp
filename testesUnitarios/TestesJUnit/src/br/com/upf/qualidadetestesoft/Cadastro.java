...
public class Cadastro {
	...
	public boolean validaEmail(){
	    ...
	    if (m.find()){
	      if(this.email.equals(this.confirmaEmail)){
	    	  return true;
	      } else {
	    	  return false;
	      }
	...
	public boolean testaCamposEmBranco(){
		if(this.apelido.isEmpty() || this.cpf.isEmpty() || this.email.isEmpty() || this.confirmaEmail.isEmpty()
				|| this.senha.isEmpty() || this.confirmaSenha.isEmpty()){
			return false;	
		} else {
			return true;
		}
